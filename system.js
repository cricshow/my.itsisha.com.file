  ...
  userNumbersRef.on("value", snap => {
    ...
    snap.forEach(childSnapshot => {
      ...
      if (currentStatus === "Approved") {
        cachedApprovedNumbersData[numberKey] = { ...numberData,
...
function showWithdrawForm() {
  ...
  document.getElementById("selectedPaymentMethod").value = ""; // Clear previously selected method
  document.querySelectorAll(".payment-method-option").forEach(option => {
...
function selectPaymentMethod(method) {
  ...
  if (selectedOption) {
    ...
    document.getElementById("selectedPaymentMethod").value = method; // Set the value of the hidden input
  }
}
...
function processWithdrawal() {
  ...
  const paymentMethod = document.getElementById("selectedPaymentMethod").value; // Correctly gets the selected payment method's value
  ...
  db.ref("payments/" + currentUser).push({
      ...
      paymentMethod: paymentMethod // This will correctly save the selected payment method
    }).then(() => {
